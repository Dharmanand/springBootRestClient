...
public class RestClientApplication implements CommandLineRunner {
	...
	public void getRxProductInfo() throws JsonParseException, JsonMappingException, IOException {
		...
		System.out.println("recordsChoice : -- > "
				+ ((Map<String, Object>) ((ArrayList<Object>) response.getBody().getOptional("recordsChoice")).get(0))
						.get("listedName"));
	...
	public void getStudents() throws JsonParseException, JsonMappingException, IOException {
		...
		List<Employee> stdList = mapper.readValue(mapper.treeAsTokens(result), new TypeReference<List<Employee>>() {
		});
